          ...
          <div className="flex-1 overflow-y-auto space-y-4">
            {posts.map((post) => (
              ...
              >
                ...
                {/* Text */}
                <p className="text-green-900 dark:text-green-100 mb-3">
                  {post.text}
                </p>

                {/* Actions */}
                <div className="flex items-center gap-4 text-sm text-green-900 dark:text-green-100">
                  <button
                ...
                <div className="mt-4 space-y-2">
                  {post.replies.map((reply, idx) => (
                    <div
                      key={idx}
                      className="p-2 rounded-lg bg-green-50 dark:bg-green-900 text-green-900 dark:text-green-100 text-sm"
                    >
