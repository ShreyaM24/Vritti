  ...
  return (
    <div className="flex min-h-screen bg-[#fdf6e3] dark:bg-gray-900 transition-colors duration-300 overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col lg:ml-64 overflow-y-auto h-screen">
        ...
        <div className="pt-20 lg:pt-6 flex flex-col gap-8 p-4 sm:p-6 lg:p-8 overflow-hidden">
          {/* Left: Counsellors */}
              ...
              {counsellors.map((doc) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-auto bg-red-500 hover:bg-red-600 text-white px-4 py-3 rounded-lg transition-colors duration-300"
                  >
                ...
                appointments.map((appt) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="mt-2 bg-red-500 hover:bg-red-600 px-3 py-2 rounded-lg text-sm text-white transition-colors duration-300 w-full"
                    >
                      Cancel
                    </button>
                  </div>
